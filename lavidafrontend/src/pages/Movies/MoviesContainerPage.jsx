...
const MoviesContainerPage = () => {
  ...
  return (
    <div className=" lg:flex-row  flex flex-col lg:justify-between items-center">
      <nav className=" ml-[4rem] md:flex-row sm:flex-row lg:flex-col xl:flex-col  flex flex-row    ">
        {genres?.map((g) => (
          <button
            key={g._id}
      ...
      <section className="flex flex-col justify-center items-center w-full lg:w-auto">
        <div className="w-full mb-8 lg:w-[100rem]">
